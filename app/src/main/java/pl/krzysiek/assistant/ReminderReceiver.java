...
public class ReminderReceiver extends BroadcastReceiver {
    ...
    @Override public void onReceive(Context c, Intent intent) {
        ...
        String text=intent.getStringExtra("text"); if(text==null) text="Masz zaplanowane przypomnienie";
        NotificationManager nm=(NotificationManager)c.getSystemService(Context.NOTIFICATION_SERVICE);
        if(Build.VERSION.SDK_INT>=26){
            NotificationChannel ch=new NotificationChannel(CHANNEL,"Przypomnienia",NotificationManager.IMPORTANCE_HIGH);
            ch.setDescription("Ważne przypomnienia Asystenta Krzyśka"); nm.createNotificationChannel(ch);
        }
        ...
        android.app.Notification n=new android.app.Notification.Builder(c,CHANNEL)
            ...
            .setContentTitle("Asystent Krzyśka")
            .setContentText(text)
